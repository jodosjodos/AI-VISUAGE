...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt ) {
      try {
        ...
        const response = await fetch("https://ai-visuage.onrender.com/api/v1/dalle", {
          method: "POST",
          headers: {
      ...
      alert("Please enter a prompt and a name");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      setLoading(true);
      try {
        const response = await fetch("https://ai-visuage.onrender.com/api/v1/post", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      alert("plese provide name and prompt");
      console.log("no fiels defined");
    }
  };
